...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dialect2.png" title="dialect" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="caption">
    Dialect survey with the Shahai Hui community in Dingtao, Heze (August 2022).
</div>
